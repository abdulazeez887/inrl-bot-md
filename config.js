...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~db339L7i77f4c54d937c85d89685c8f8f029', //your ssid to run bot
    HEROKU: {
    ...
    ALLWAYS_ONLINE: toBool(process.env.ALLWAYS_ONLINE || "ture"),
    PM_BLOCK : toBool(process.env.PM_BLOCK || "false"),
    BGMBOT : toBool(process.env.BGMBOT || "false"),
    CALL_BLOCK : toBool(process.env.CALL_BLOCK || "false"),
    STATUS_VIEW : process.env.STATUS_VIEW || "ture",
    SAVE_STATUS : toBool(process.env.SAVE_STATUS || "ture"),
    ADMIN_SUDO_ACCESS: toBool(process.env.ADMIN_SUDO_ACCESS || "ture"),
